    ...
    <>
      ...
      <section className={styles.pageHeader}>
        <div className="container">
          ...
          <p className={styles.pageSubtitle}>Barisan dan Deret Aritmatika dan Geometri</p>
        </div>
      </section>
          ...
          <div className={styles.pdfContainer}>
            <div className={styles.pdfToolbar}>
              <div className={styles.pdfInfo}>
                ...
                <div className={styles.pdfTitle}>Modul Barisan dan Deret Geometri.pdf</div>
              </div>
            ...
            <div className={styles.pdfContent}>
              <div className={styles.pdfPage}>
                ...
                <h2 className={styles.moduleSubtitle}>BARISAN DAN DERET GEOMETRI</h2>
                ...
                <div className={styles.contentSection}>
                  ...
                  <p className={styles.contentParagraph}>Perhatikan ilustrasi di bawah ini</p>
                  ...
                  <div className={styles.illustrationContainer}>
                    ...
                    <div className={styles.textContainer}>
                      <p>Seorang pedagang buah menata dagangannya secara bersusun menyerupai piramida. Baris paling bawah (pertama) diisi 30 jeruk, kemudian baris ke-2 (di atasnya) berisi 28 jeruk, baris di atasnya lagi 26 jeruk, begitu seterusnya.</p>
                      <p>Dapatkah kalian menentukan berapa banyak jeruk pada baris ke-15? Untuk lebih jelasnya mari kita belajar tentang Barisan Aritmetika. Agar kita lebih mudah memahami pengertian barisan bilangan, maka perhatikan contoh urutan bilangan berikut:</p>
                    </div>
                  </div>
                  ...
                  <p>Pada contoh a) <i>U₁ + U₂ + U₃ + U₄ + ... + Uₙ</i> atau dituliskan dengan <i>aⁿ + aⁿ + aⁿ + aⁿ + ... + aⁿ</i></p>
                  
                  <p>Contoh a) 1, 2, 3, 5, 8, 11, ... mempunyai aturan tertentuya adalah bilangan 2, 5, 8, 11, ... mempunyai aturan tertentu yaitu Un = Un-1 + 3. Bilangan pada contoh c) dan d) tidak mempunyai aturan tertentu, sehingga bukan merupakan suatu barisan bilangan.</p>
                  ...
                  <div className={styles.formulaContainer}>
                    <div>
                      ...
                      <p>U2 = suku ke - 2</p>
                      <p>U3 = suku ke - 3</p>
                      <p style={{marginTop: '0.5rem'}}>Un = suku ke - n (suku ke-n barisan bilangan)</p>
                    </div>
                  ...
                  <p className={styles.contentParagraph}>Pola bilangan adalah susunan angka atau bilangan yang mengikuti aturan tertentu. Pola ini bisa berupa penambahan, pengurangan, perkalian, pembagian, atau bentuk lainnya.</p>
